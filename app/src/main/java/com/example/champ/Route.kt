...
sealed class Route() {
    ...
    @Serializable data class Menu(val isRating: Boolean? = null): Route()
    ...
    @Serializable data object Placed: Route()
    @Serializable data object MyOrderCurrent: Route()
    @Serializable data object MyOrderHistory: Route()
